...
window.addEventListener('load', () => {
    setTimeout(() => {
        showToast("Здравствуйте!", "Welcome to KYAMC Cultural Week 2026 Portal. Curiosity → Questions → Learning → Understanding → Growth ");
...
function updateClockAndPrayer() {
    ...
    const prayers = [
        { id: 'fajr', name: 'Fajr', time: '05:25' },
        { id: 'dhuhr', name: 'Dhuhr', time: '01:30' },
